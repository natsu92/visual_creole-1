...
ofVec3f leftPointerThumbAt;//親指
ofVec3f rightPointerThumbAt;
ofVec3f leftPointerIndexAt;//人差し指
ofVec3f rightPointerIndexAt;
ofVec3f leftPointerMiddleAt;//中指
ofVec3f rightPointerMiddleAt;
ofVec3f leftPointerRingAt;//薬指
ofVec3f rightPointerRingAt;
ofVec3f leftPointerPinkyAt;//小指
...
bool rightPointerThumbFound, leftPointerThumbFound;//親指 
bool rightPointerIndexFound, leftPointerIndexFound;//人差し指
bool rightPointerMiddleFound, leftPointerMiddleFound;//中指
bool rightPointerRingFound, leftPointerRingFound;//薬指
bool rightPointerPinkyFound, leftPointerPinkyFound;//小指
...
void ofApp::setup() {
	...
	fbo_face.allocate(700, 700, GL_RGBA);//サイズと色
	drawing_face = false;
